export const programs = [
  ...
  },
  {
    ...
    description: "One-on-one support connecting donors with children in need.",
    image: "/mentor-helping-child-with-studies.jpg",
    fullDescription:
...
export const events = [
  ...
  },
  {
    ...
    description: "Help us beautify our community while supporting our cause.",
...
export const blogPosts = [
  {
    ...
    excerpt:
      "Discover how our education program is transforming lives and creating opportunities for underprivileged children.",
